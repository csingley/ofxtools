...
class TESTAGGREGATE(Aggregate):
    ...
    sub = SubAggregate(TESTSUBAGGREGATE)
    dontuse = Unsupported()
...
class AggregateTestCase(unittest.TestCase):
    ...
    def instance_with_subagg(self):
        ...
        return TESTAGGREGATE(metadata='foo', sub=subagg)
...
class ListTestCase(unittest.TestCase):
    ...
    def instance(self):
        ...
        agg0 = TESTAGGREGATE(metadata='foo', sub=subagg0)
        subagg1 = TESTSUBAGGREGATE(data='quuz')
        agg1 = TESTAGGREGATE(metadata='bar', sub=subagg1)
